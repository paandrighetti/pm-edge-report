...
- **Resolved markets.** On {bt_markets} markets, favorites are overpriced rather than cheap
  ...
  t = {fc_t}); the Dutch-book residual goes flat and the best hedge cell (t = {bh_is_t})
  reverses (t = {bh_oos_t}).
...
- **Cross-venue arbitrage.** Exact Kalshi and Polymarket pairs show {xa_exact_cf_edge} of
  ...
  settling on different sources show more edge ({xa_basis_edge}) and a negative result
